(function($) {
	...
	$(document).ready(function() {
		...
		$( document ).on( 'focusout', '#mycred-range-selector input', function(){
		...
		$( document ).on( 'change', '#mycred-range-selector input', function(){
		...
		$( document ).on( 'click', '#mycred-apply-partial-payment', function(e){
