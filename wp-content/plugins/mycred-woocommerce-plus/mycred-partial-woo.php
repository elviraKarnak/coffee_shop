...
if ( ! class_exists( 'myCRED_WooCommerce_Partial' ) ) :
	final class myCRED_WooCommerce_Partial {
		...
		public function woocommerce() {
			...
			add_action( 'woocommerce_before_checkout_form', 	 array( $this, 'mycred_woocommerce_checkout_before_customer_details'), 10, 1 );
		...
		public function mycred_woocommerce_cart_collaterals(){
			...
			if ( $setting == 'enable_coupons' )
			{

				echo mycred_pro_render_points_to_coupon($atts, $content); 
			...
			if ( ( $change_position == 'both' ) 
				...
				{
				?>	<style> .cart-collaterals #mycred-partial-payment-woo { float : left; width: 45% } </style>
