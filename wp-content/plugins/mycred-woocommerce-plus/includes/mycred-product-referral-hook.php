...
//			// Points for visits
            ...
            public function shortcode_woo_product_referral_link($content = '', $atts) {
                ...
                <h3 class="mycred_woo_generate"><?php _e('Generate Link'); ?></h3>
                <p class="mycred_woo_affiliate_id"><?php _e('your affiliate id is: ' . $this->get_ref_id($user_id)); ?></p>
                <p class="mycred_woo_referral_url"><?php _e('your referral url is: ' . $this->get_ref_link($user_id, $url)); ?></p>
                ...
                if (!empty($products)) :
                    ...
                    <form method="post" name="mycred-woo-product-referral-form"> 
                        ...
                        <div class="form-row form-row-wide mycred_woo_product_url">
