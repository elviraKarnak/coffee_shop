...
class MyCred_woo_badge_rank_copouns {
	...
	//if (  'mycred_badge' != get_post_type() ) return;
		...
		plugins_url( 'assets/css/badge_rank_coupons_style.css', MYCRED_WOOPLUS_THIS, MYCRED_WOOPLUS_VERSION ));
		...
		if ( get_post_type() == 'mycred_badge' ) {	
			...
			plugins_url( 'assets/js/mycred-badge-rank-coupons.js', MYCRED_WOOPLUS_THIS ), array('jquery'), MYCRED_WOOPLUS_VERSION);
