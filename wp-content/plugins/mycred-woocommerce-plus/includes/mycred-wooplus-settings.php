...
class myCred_wooplus_Settings {
	...
	public static function wooplus_text_html ($value) {
		echo '<tr><td colspan="2"><p>If you enable the partial payment feature then myCred Gateway add-on will disable automatically.</p></td></tr>';
	}

	public static function add_js_for_rewards_points_tab() {
		if( !empty( $_GET['section'] ) && $_GET['section'] == 'reward_points' ){
    ...
    public static function get_settings( $section = null) {
       ...
       switch( $current_section ){
		...
		$settings = array(
			...
			array(
				'title'       => __( '', 'mycredpartwoo' ),
				'desc'        => __( '', 'mycredpartwoo' ),
			...
			array(
				'title'       => __( 'Select Position to dispaly', 'mycredpartwoo' ),
				'desc'        => __( '', 'mycredpartwoo' ),
			...
			array(
				...
				'class'       => 'wc-enhanced-select partial',
				'css'         => 'min-width:300px;',
